...
int main(int argc, char** argv)
{
    ...
    getopt_add_int(gopt, '\0', kNumParticlesArg, "600", "Number of particles to use in the particle filter");
    getopt_add_int(gopt, '\0', kHitOddsArg, "8", "Amount to increase log-odds when a cell is hit by a laser ray");
